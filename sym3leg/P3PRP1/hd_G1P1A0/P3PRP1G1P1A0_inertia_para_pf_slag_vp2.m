...
function MX = P3PRP1G1P1A0_inertia_para_pf_slag_vp2(xP, qJ, legFrame, ...
  koppelP, pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(3,1),zeros(3,3),zeros(3,3),zeros(3,3),zeros(3,1),zeros(3+1,1),zeros(3+1,3),zeros(3+1,6)}
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: xP has to be [3x1] (double)');
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: qJ has to be [3x3] (double)');
assert(isreal(pkin) && all(size(pkin) == [3 1]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: pkin has to be [3x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: m has to be [4x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [4,3]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: mrSges has to be [4x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [4 6]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: Ifges has to be [4x6] (double)'); 
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3PRP1G1P1A0_inertia_para_pf_slag_vp2: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From inertia_para_plfcoord_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2019-05-03 14:41:43
% EndTime: 2019-05-03 14:41:44
% DurationCPUTime: 0.93s
% Computational Cost: add. (5978->244), mult. (10997->366), div. (432->3), fcn. (5066->14), ass. (0->155)
t426 = 2 * pkin(2);
t425 = 2 * mrSges(3,3);
t383 = pkin(2) ^ 2;
t424 = 1 + t383;
...
t397 = pkin(2) * t416;
t396 = pkin(2) * t418;
t395 = mrSges(3,1) * t426 + Ifges(3,2) + Ifges(2,3);
...
t336 = t405 * m(3) + qJ(3,1) * t425 + t395;
t335 = t406 * m(3) + qJ(3,2) * t425 + t395;
t334 = t407 * m(3) + qJ(3,3) * t425 + t395;
t333 = t347 * t353 + 0.2e1 * t401;
t332 = t346 * t352 + 0.2e1 * t400;
t331 = t345 * t351 + 0.2e1 * t399;
t330 = (m(3) * qJ(3,1) + t420) * t367 + t344 * t370;
t329 = (m(3) * qJ(3,2) + t420) * t366 + t344 * t369;
t328 = (m(3) * qJ(3,3) + t420) * t365 + t344 * t368;
t327 = 0.1e1 / (t367 * t408 * t426 + t347 * t361 - t405 - 0.1e1);
t326 = 0.1e1 / (t366 * t409 * t426 + t346 * t360 - t406 - 0.1e1);
t325 = 0.1e1 / (t365 * t410 * t426 + t345 * t359 - t407 - 0.1e1);
t324 = t353 * t402 + t367 * (pkin(2) * t353 + t419);
t323 = t350 * t402 + t367 * (pkin(2) * t350 - t418);
t322 = t352 * t403 + t366 * (pkin(2) * t352 + t417);
t321 = t349 * t403 + t366 * (pkin(2) * t349 - t416);
t320 = t351 * t404 + t365 * (pkin(2) * t351 + t415);
t319 = t348 * t404 + t365 * (pkin(2) * t348 - t414);
...
t312 = -t333 * t411 + t383 * t350 + t392 * t361 + t350 - t396;
t311 = t333 * t361 - t353 * t383 + t392 * t411 - t353 - t401;
t310 = -t332 * t412 + t383 * t349 + t389 * t360 + t349 - t397;
t309 = t332 * t360 - t352 * t383 + t389 * t412 - t352 - t400;
t308 = -t331 * t413 + t383 * t348 + t386 * t359 + t348 - t398;
t307 = t331 * t359 - t351 * t383 + t386 * t413 - t351 - t399;
...
t291 = (t312 * t357 - t315 * t421 + t324 * t330) * t327;
t290 = (t311 * t357 - t318 * t421 + t323 * t330) * t327;
t289 = (t310 * t357 - t314 * t422 + t322 * t329) * t326;
t288 = (t309 * t357 - t317 * t422 + t321 * t329) * t326;
t287 = (t308 * t357 - t313 * t423 + t320 * t328) * t325;
t286 = (t307 * t357 - t316 * t423 + t319 * t328) * t325;
...
t276 = t300 * t357 - t303 * t421 + t306 * t330;
t275 = t299 * t357 - t302 * t422 + t305 * t329;
t274 = t298 * t357 - t301 * t423 + t304 * t328;
