...
function tauX = P3PRP1G1P1A0_invdyn_para_pf_slag_vp1(xP, xDP, xDDP, qJ, g, legFrame, ...
...
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: xP has to be [3x1] (double)');
assert(isreal(xDP) && all(size(xDP) == [3 1]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: xDP has to be [3x1] (double)');
assert(isreal(xDDP) && all(size(xDDP) == [3 1]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: xDDP has to be [3x1] (double)');
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: qJ has to be [3x3] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [3 1]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: pkin has to be [3x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: m has to be [4x1] (double)'); 
assert(isreal(rSges) && all(size(rSges) == [4,3]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: rSges has to be [4x3] (double)');
assert(isreal(Icges) && all(size(Icges) == [4 6]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: Icges has to be [4x6] (double)'); 
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3PRP1G1P1A0_invdyn_para_pf_slag_vp1: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From invdyn_para_plfcoord_par1_matlab.m
% OptimizationMode: 2
% StartTime: 2019-05-03 14:41:30
% EndTime: 2019-05-03 14:41:33
...
t224 = pkin(2) * t231;
t267 = 2 * qJ(3,1);
t111 = 0.1e1 / (t141 * t155 + t224 * t267 - t157 - t183);
t178 = xP(3);
t149 = sin(t178);
t150 = cos(t178);
t186 = koppelP(1,2);
...
t225 = pkin(2) * t232;
t266 = 2 * qJ(3,2);
t110 = 0.1e1 / (t140 * t154 + t225 * t266 - t157 - t182);
t185 = koppelP(2,2);
t188 = koppelP(2,1);
...
t226 = pkin(2) * t233;
t265 = 2 * qJ(3,3);
t109 = 0.1e1 / (t139 * t153 + t226 * t265 - t157 - t181);
t184 = koppelP(3,2);
t187 = koppelP(3,1);
...
t206 = -t141 * t144 + 0.2e1 * t218;
t203 = -t140 * t143 + 0.2e1 * t219;
t200 = -t139 * t142 + 0.2e1 * t220;
t180 = rSges(4,1);
t179 = rSges(4,2);
t166 = xDDP(1);
t165 = xDDP(2);
...
t120 = t141 * t147 + 0.2e1 * t223;
t119 = t140 * t146 + 0.2e1 * t222;
t118 = t139 * t145 + 0.2e1 * t221;
...
t84 = -t120 * t231 + t193 * t144 + t206 * t155 + t144 - t218;
t83 = t120 * t155 - t147 * t193 + t206 * t231 - t147 - t223;
t82 = -t119 * t232 + t193 * t143 + t203 * t154 + t143 - t219;
t81 = t119 * t154 - t146 * t193 + t203 * t232 - t146 - t222;
t80 = -t118 * t233 + t193 * t142 + t200 * t153 + t142 - t220;
t79 = t118 * t153 - t145 * t193 + t200 * t233 - t145 - t221;
...
t18 = ((0.2e1 * (t66 + (-t252 / 0.2e1 - t249 / 0.2e1) * t111) * t243 - (pkin(2) * t30 - t60) * t231 - qJ(3,1) * t274) * t111 + (-qJ(3,1) + t224 - t243) * t111 * t274) * t69;
t17 = ((0.2e1 * (t65 + (-t253 / 0.2e1 - t250 / 0.2e1) * t110) * t239 - (pkin(2) * t29 - t59) * t232 - qJ(3,2) * t273) * t110 + (-qJ(3,2) + t225 - t239) * t110 * t273) * t68;
t16 = ((0.2e1 * (t64 + (-t254 / 0.2e1 - t251 / 0.2e1) * t109) * t235 - (pkin(2) * t28 - t58) * t233 - qJ(3,3) * t272) * t109 + (-qJ(3,3) + t226 - t235) * t109 * t272) * t67;
...
t3 = -t108 * t18 + t15 * t259 - ((t138 * t69 + t271 * t274) * t169 + t215 * t172 * t69) * t69 - t246 * t151;
t2 = -t107 * t17 + t14 * t260 - ((t138 * t68 + t271 * t273) * t168 + t216 * t171 * t68) * t68 - t247 * t151;
t1 = -t106 * t16 + t13 * t261 - ((t138 * t67 + t271 * t272) * t167 + t217 * t170 * t67) * t67 - t248 * t151;
