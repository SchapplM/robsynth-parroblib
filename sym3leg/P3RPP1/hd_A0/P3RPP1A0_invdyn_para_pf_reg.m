...
function tauX_reg = P3RPP1A0_invdyn_para_pf_reg(xP, xDP, xDDP, qJ, g, legFrame, ...
  koppelP, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(3,1),zeros(3,1),zeros(3,1),zeros(3,3),zeros(3,1),zeros(3,3),zeros(3,3),zeros(3,1)}
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3RPP1A0_invdyn_para_pf_reg: xP has to be [3x1] (double)');
assert(isreal(xDP) && all(size(xDP) == [3 1]), ...
  'P3RPP1A0_invdyn_para_pf_reg: xDP has to be [3x1] (double)');
assert(isreal(xDDP) && all(size(xDDP) == [3 1]), ...
  'P3RPP1A0_invdyn_para_pf_reg: xDDP has to be [3x1] (double)');
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3RPP1A0_invdyn_para_pf_reg: qJ has to be [3x3] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'P3RPP1A0_invdyn_para_pf_reg: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [3 1]), ...
  'P3RPP1A0_invdyn_para_pf_reg: pkin has to be [3x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3RPP1A0_invdyn_para_pf_reg: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3RPP1A0_invdyn_para_pf_reg: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From invdyn_para_plfcoord_reg_matlab.m
% OptimizationMode: 2
% StartTime: 2018-12-20 17:50:44
% EndTime: 2018-12-20 17:50:54
...
t327 = koppelP(1,1);
t441 = (qJ(2,1) * t327);
t164 = t324 * t392 + pkin(1) * t441 + (t324 * t328 + t441) * qJ(3,1);
t489 = 2 * qJ(3,1);
...
t398 = t313 * t328;
t402 = t508 * t313;
t490 = (t164 * t291 + t165 * t290) * t311 + (pkin(1) * t275) - ((-t275 + t398) * qJ(3,1)) - (t320 * t313) - t402;
t289 = pkin(1) * t312;
t269 = 2 * t289;
t276 = qJ(2,1) * t313;
t403 = t508 * t312;
...
t326 = koppelP(2,1);
t439 = (qJ(2,2) * t326);
t162 = t323 * t393 + pkin(1) * t439 + (t323 * t328 + t439) * qJ(3,2);
t488 = 2 * qJ(3,2);
...
t273 = qJ(2,2) * t312;
t491 = (t162 * t291 + t163 * t290) * t311 + (pkin(1) * t273) - ((-t273 + t398) * qJ(3,2)) - (t318 * t313) - t402;
t274 = qJ(2,2) * t313;
...
t325 = koppelP(3,1);
t437 = (qJ(2,3) * t325);
t160 = t322 * t394 + pkin(1) * t437 + (t322 * t328 + t437) * qJ(3,3);
t487 = 2 * qJ(3,3);
...
t271 = qJ(2,3) * t312;
t492 = t311 * (t160 * t291 + t161 * t290) + (pkin(1) * t271) - ((-t271 + t398) * qJ(3,3)) - (t316 * t313) - t402;
t272 = qJ(2,3) * t313;
...
t106 = (t299 * t271) + (t317 * t313) + t313 + (t194 * t291 - t195 * t290) * t311;
t107 = -(t299 * t272) + (t317 * t312) + t312 + (t194 * t290 + t195 * t291) * t311;
t70 = (t106 * t305 - t107 * t308) * t280 + t277 * (t106 * t308 + t107 * t305);
t371 = qJ(2,3) * t70 + t299 * t61;
t219 = 1 / t233 ^ 2;
t220 = t218 * t219;
t112 = (qJ(3,3) * t312) + t272 + t289 + (-t290 * t499 + t291 * t500) * t311;
t113 = t271 - (t299 * t313) + (t290 * t500 + t291 * t499) * t311;
t76 = (t112 * t308 + t113 * t305) * t280 + t277 * (-t112 * t305 + t113 * t308);
t451 = t220 * t76;
t453 = t219 * t76;
...
t108 = (t300 * t273) + (t319 * t313) + t313 + (t196 * t291 - t197 * t290) * t311;
t109 = -(t300 * t274) + (t319 * t312) + t312 + (t196 * t290 + t197 * t291) * t311;
t71 = (t108 * t306 - t109 * t309) * t281 + t278 * (t108 * t309 + t109 * t306);
t372 = qJ(2,2) * t71 + t300 * t62;
t222 = 1 / t234 ^ 2;
t223 = t221 * t222;
t114 = (qJ(3,2) * t312) + t274 + t289 + (-t290 * t501 + t291 * t502) * t311;
t115 = t273 - (t300 * t313) + (t290 * t502 + t291 * t501) * t311;
t77 = (t114 * t309 + t115 * t306) * t281 + t278 * (-t114 * t306 + t115 * t309);
t447 = t223 * t77;
t449 = t222 * t77;
...
t110 = (t301 * t275) + (t321 * t313) + t313 + (t198 * t291 - t199 * t290) * t311;
t111 = -(t301 * t276) + (t321 * t312) + t312 + (t198 * t290 + t199 * t291) * t311;
t72 = (t110 * t307 - t111 * t310) * t282 + t279 * (t110 * t310 + t111 * t307);
t373 = qJ(2,1) * t72 + t301 * t63;
t225 = 1 / t235 ^ 2;
t226 = t224 * t225;
t116 = (qJ(3,1) * t312) + t276 + t289 + (-t290 * t503 + t291 * t504) * t311;
t117 = t275 - (t301 * t313) + (t290 * t504 + t291 * t503) * t311;
t78 = (t116 * t310 + t117 * t307) * t282 + t279 * (-t116 * t307 + t117 * t310);
t443 = t226 * t78;
t445 = t225 * t78;
...
t79 = (-t136 * t290 + t137 * t291) * t280 + t277 * (t136 * t291 + t137 * t290);
t469 = t37 * t79;
t138 = t196 * t309 + t197 * t306;
t139 = t196 * t306 - t197 * t309;
t80 = (-t138 * t290 + t139 * t291) * t281 + t278 * (t138 * t291 + t139 * t290);
t468 = t38 * t80;
t140 = t198 * t310 + t199 * t307;
t141 = t198 * t307 - t199 * t310;
t81 = (-t140 * t290 + t141 * t291) * t282 + t279 * (t140 * t291 + t141 * t290);
t467 = t39 * t81;
t466 = qJ(2,1) * t63;
t75 = t78 ^ 2;
t465 = qJ(2,1) * t75;
...
t82 = (t154 * t291 + t157 * t290) * t280 - t277 * (-t154 * t290 + t157 * t291);
t454 = t218 * t82;
t452 = t220 * t73;
t155 = t306 * t501 + t309 * t502;
t158 = t306 * t502 - t309 * t501;
t83 = (t155 * t291 + t158 * t290) * t281 - t278 * (-t155 * t290 + t158 * t291);
t450 = t221 * t83;
t448 = t223 * t74;
t156 = t307 * t503 + t310 * t504;
t159 = t307 * t504 - t310 * t503;
t84 = (t156 * t291 + t159 * t290) * t282 - t279 * (-t156 * t290 + t159 * t291);
t446 = t224 * t84;
t444 = t226 * t75;
t436 = t130 * t218;
t435 = t131 * t221;
...
t352 = -t444 * t81 - t448 * t80 - t452 * t79;
...
t69 = (t104 * t291 - t105 * t290) * t282 + t279 * (t104 * t290 + t105 * t291);
t68 = (t102 * t291 - t103 * t290) * t281 + t278 * (t102 * t290 + t103 * t291);
t67 = (t100 * t291 - t101 * t290) * t280 + t277 * (t100 * t290 + t101 * t291);
t54 = t63 * t395;
t53 = t62 * t396;
t52 = t61 * t397;
t30 = t60 + t493;
...
t12 = (t267 * t307 - t268 * t310) * t282 + (t267 * t310 + t268 * t307) * t279 + t39 * t321 + qJ(2,1) * t60 + pkin(1) * (-t377 + t483);
