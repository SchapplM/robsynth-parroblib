...
% Datum: 2019-01-03 11:55
% Revision: 73fedb8d52c8ee36c720354c027a250325027d46
% Moritz Schappler, moritz.schappler@imes.uni-hannover.de
% (C) Institut für mechatronische Systeme, Universität Hannover

function tauX_reg = P3RPP1G1P1A0_invdyn_para_pf_reg(xP, xDP, xDDP, qJ, g, legFrame, ...
  koppelP, pkin)
%% Coder Information
%#codegen
%$cgargs {zeros(3,1),zeros(3,1),zeros(3,1),zeros(3,3),zeros(3,1),zeros(3,3),zeros(3,3),zeros(3,1)}
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: xP has to be [3x1] (double)');
assert(isreal(xDP) && all(size(xDP) == [3 1]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: xDP has to be [3x1] (double)');
assert(isreal(xDDP) && all(size(xDDP) == [3 1]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: xDDP has to be [3x1] (double)');
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: qJ has to be [3x3] (double)');
assert(isreal(g) && all(size(g) == [3 1]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: g has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [3 1]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: pkin has to be [3x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3RPP1G1P1A0_invdyn_para_pf_reg: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From invdyn_para_plfcoord_reg_matlab.m
% OptimizationMode: 2
% StartTime: 2019-01-03 11:55:45
% EndTime: 2019-01-03 11:55:55
...
t63 = (t93 * t307 - t310 * t490) * t282 + (t307 * t490 + t93 * t310) * t279;
t507 = t480 * t63;
t319 = (qJ(2,2) ^ 2);
t481 = -t319 - 1;
t297 = legFrame(2,3);
...
t62 = (t92 * t306 - t309 * t491) * t281 + (t306 * t491 + t92 * t309) * t278;
t506 = t481 * t62;
t317 = (qJ(2,3) ^ 2);
t482 = -t317 - 1;
t296 = legFrame(3,3);
...
t61 = (t91 * t305 - t308 * t492) * t280 + (t305 * t492 + t91 * t308) * t277;
t505 = t482 * t61;
t404 = t301 * t327;
t504 = t404 - t442;
t405 = t301 * t324;
