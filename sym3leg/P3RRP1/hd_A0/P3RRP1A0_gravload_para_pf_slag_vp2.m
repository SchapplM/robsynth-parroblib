...
function taugX = P3RRP1G1P1A0_gravload_para_pf_slag_vp2(xP, qJ, g, legFrame, ...
  koppelP, pkin, m, mrSges)
%% Coder Information
%#codegen
%$cgargs {zeros(3,1),zeros(3,3),zeros(3,1),zeros(3,3),zeros(3,3),zeros(4,1),zeros(3+1,1),zeros(3+1,3)}
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: xP has to be [3x1] (double)');
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: qJ has to be [3x3] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: pkin has to be [4x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: m has to be [4x1] (double)'); 
assert(isreal(g) && all(size(g) == [3 1]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: g has to be [3x1] (double)');
assert(isreal(mrSges) && all(size(mrSges) == [4,3]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: mrSges has to be [4x3] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3RRP1G1P1A0_gravload_para_pf_slag_vp2: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From gravvec_para_plfcoord_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2019-05-03 15:06:26
% EndTime: 2019-05-03 15:06:28
% DurationCPUTime: 2.23s
% Computational Cost: add. (2292->347), mult. (4616->508), div. (36->3), fcn. (2066->20), ass. (0->247)
t1849 = (qJ(3,3) ^ 2);
t1859 = pkin(1) ^ 2;
t1843 = cos(qJ(1,3));
t1827 = t1843 ^ 2;
...
t1709 = 0.1e1 / ((pkin(1) * (t1801 * t1892 + (0.2e1 * t1827 - 0.1e1) * t1931) * t1804 + t1917) * t1807 * t1943 + pkin(1) * t1916 * t1936 - t1849 * t1833 + (0.2e1 * (t1849 / 0.2e1 - t1860 + t1887) * t1798 + t1860) * t1859);
...
t1710 = 0.1e1 / ((pkin(1) * (t1802 * t1890 + (0.2e1 * t1828 - 0.1e1) * t1932) * t1805 + t1919) * t1808 * t1943 + pkin(1) * t1915 * t1935 - t1850 * t1833 + (0.2e1 * (t1850 / 0.2e1 - t1861 + t1887) * t1799 + t1861) * t1859);
...
t1711 = 0.1e1 / (((t1803 * t1888 + (0.2e1 * t1829 - 0.1e1) * t1933) * t1929 + t1921) * t1809 * t1943 + qJ(3,1) * t1929 * t1934 - t1851 * t1833 + (0.2e1 * (t1851 / 0.2e1 - t1862 + t1887) * t1800 + t1862) * t1859);
...
t1708 = (t1771 * mrSges(1,2) - t1768 * t1787) * t1845 + (t1768 * mrSges(1,2) + t1787 * t1771) * t1842 + t1714;
t1707 = (t1770 * mrSges(1,2) - t1767 * t1787) * t1844 + (t1767 * mrSges(1,2) + t1787 * t1770) * t1841 + t1713;
t1706 = (t1769 * mrSges(1,2) - t1766 * t1787) * t1843 + (t1766 * mrSges(1,2) + t1787 * t1769) * t1840 + t1712;
...
t1699 = (-t1944 * t1812 + t1783 + t1869) * t1809 + (t1872 * t1815 + t1774 + t1780) * t1806 + (-t1738 * t1800 - t1737 * t1903 + (t1793 - 0.2e1 * t1922) * t1845 + t1842 * t1790) * pkin(1);
t1698 = (-t1945 * t1811 + t1782 + t1870) * t1808 + (t1873 * t1814 + t1773 + t1779) * t1805 + (-t1736 * t1799 - t1735 * t1904 + (t1792 - 0.2e1 * t1920) * t1844 + t1841 * t1789) * pkin(1);
t1697 = (-t1946 * t1810 + t1781 + t1871) * t1807 + (t1874 * t1813 + t1772 + t1778) * t1804 + (-t1734 * t1798 - t1733 * t1905 + (t1791 - 0.2e1 * t1918) * t1843 + t1840 * t1788) * pkin(1);
t1696 = (t1944 * t1815 + t1774 + t1940) * t1809 + (t1872 * t1812 + t1783 - t1869) * t1806 + (-t1738 * t1903 + t1737 * t1800 + t1790 * t1934 + (-t1921 - t1923) * t1815) * pkin(1);
t1695 = (t1945 * t1814 + t1773 + t1941) * t1808 + (t1873 * t1811 + t1782 - t1870) * t1805 + (-t1736 * t1904 + t1735 * t1799 + t1789 * t1935 + (-t1919 - t1924) * t1814) * pkin(1);
t1694 = (t1946 * t1813 + t1772 + t1942) * t1807 + (t1874 * t1810 + t1781 - t1871) * t1804 + (-t1734 * t1905 + t1733 * t1798 + t1788 * t1936 + (-t1917 - t1925) * t1813) * pkin(1);
t1693 = -t1834 * t1878 - t1909 + (t1723 * t1903 - t1729 * t1800 + t1777 * t1762) * pkin(1) + ((t1864 - t1926) * t1809 + t1863 * t1806) * t1859;
t1692 = -t1834 * t1879 - t1910 + (t1722 * t1904 - t1728 * t1799 + t1776 * t1758) * pkin(1) + ((t1866 - t1927) * t1808 + t1865 * t1805) * t1859;
t1691 = -t1834 * t1880 - t1911 + (t1721 * t1905 - t1727 * t1798 + t1775 * t1754) * pkin(1) + ((t1868 - t1928) * t1807 + t1867 * t1804) * t1859;
