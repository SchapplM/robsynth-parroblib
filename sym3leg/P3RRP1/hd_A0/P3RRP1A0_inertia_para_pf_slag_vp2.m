...
function MX = P3RRP1A0_inertia_para_pf_slag_vp2(xP, qJ, legFrame, ...
  koppelP, pkin, m, mrSges, Ifges)
%% Coder Information
%#codegen
%$cgargs {zeros(3,1),zeros(3,3),zeros(3,3),zeros(3,3),zeros(4,1),zeros(3+1,1),zeros(3+1,3),zeros(3+1,6)}
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: xP has to be [3x1] (double)');
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: qJ has to be [3x3] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: pkin has to be [4x1] (double)');
assert(isreal(m) && all(size(m) == [4 1]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: m has to be [4x1] (double)'); 
assert(isreal(mrSges) && all(size(mrSges) == [4,3]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: mrSges has to be [4x3] (double)');
assert(isreal(Ifges) && all(size(Ifges) == [4 6]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: Ifges has to be [4x6] (double)'); 
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3RRP1A0_inertia_para_pf_slag_vp2: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From inertia_para_plfcoord_par2_matlab.m
% OptimizationMode: 2
% StartTime: 2018-12-20 18:01:24
% EndTime: 2018-12-20 18:01:28
% DurationCPUTime: 3.70s
% Computational Cost: add. (23150->452), mult. (50282->641), div. (432->3), fcn. (21104->26), ass. (0->286)
t897 = pkin(1) ^ 2;
...
t878 = cos(qJ(2,3));
t903 = ((m(3) * qJ(3,3) + t963) * sin(qJ(2,3)) + t823 * t878) * pkin(1);
t880 = cos(qJ(2,2));
t902 = ((m(3) * qJ(3,2) + t963) * sin(qJ(2,2)) + t823 * t880) * pkin(1);
t882 = cos(qJ(2,1));
t901 = ((m(3) * qJ(3,1) + t963) * sin(qJ(2,1)) + t823 * t882) * pkin(1);
t900 = -t829 * t861 + 0.2e1 * t930 * t972;
t899 = -t828 * t860 + 0.2e1 * t931 * t971;
t898 = -t827 * t859 + 0.2e1 * t932 * t970;
t895 = koppelP(1,1);
t894 = koppelP(2,1);
t893 = koppelP(3,1);
t892 = koppelP(1,2);
...
t746 = (t803 + t948) * t883 + t877 * t767;
t745 = (t802 + t949) * t881 + t875 * t766;
t744 = (t801 + t950) * t879 + t873 * t765;
t743 = t770 * t883 + ((t867 + t858) * t841 + t809) * t976;
t742 = t769 * t881 + ((t867 + t857) * t840 + t808) * t977;
t741 = t768 * t879 + ((t867 + t856) * t839 + t807) * t978;
t740 = 0.1e1 / (((t829 * t930 + (0.2e1 * t861 - 0.1e1) * t972) * pkin(1) * t832 + t961) * t835 * t983 + pkin(1) * t943 * t973 - t889 * t865 + (0.2e1 * (t889 / 0.2e1 - t900 + t929) * t826 + t900) * t897);
t739 = 0.1e1 / (((t828 * t931 + (0.2e1 * t860 - 0.1e1) * t971) * pkin(1) * t831 + t959) * t834 * t983 + pkin(1) * t945 * t974 - t888 * t865 + (0.2e1 * (t888 / 0.2e1 - t899 + t929) * t825 + t899) * t897);
t738 = 0.1e1 / (((t827 * t932 + (0.2e1 * t859 - 0.1e1) * t970) * pkin(1) * t830 + t957) * t833 * t983 + pkin(1) * t947 * t975 - t887 * t865 + (0.2e1 * (t887 / 0.2e1 - t898 + t929) * t824 + t898) * t897);
t737 = (-t936 + t939) * qJ(3,1) + (-t764 * t826 - t746 * t942 + (t838 * t896 + t838 - t927) * t883 + (-(t979 - t948) * t826 - qJ(3,1) * t791) * t877) * pkin(1);
t736 = (-t937 + t940) * qJ(3,2) + (-t763 * t825 - t745 * t944 + (t837 * t896 + t837 - t926) * t881 + (-(t980 - t949) * t825 - qJ(3,2) * t787) * t875) * pkin(1);
t735 = (-t938 + t941) * qJ(3,3) + (-t762 * t824 - t744 * t946 + (t836 * t896 + t836 - t925) * t879 + (-(t981 - t950) * t824 - qJ(3,3) * t783) * t873) * pkin(1);
t734 = -t921 - t951 + (t746 * t826 - (t764 + ((t858 + t928) * t841 + t809) * t976) * t942 - (t841 * t896 + t809 + t841) * t883 + qJ(3,1) * t954) * pkin(1);
t733 = -t922 - t952 + (t745 * t825 - (t763 + ((t857 + t928) * t840 + t808) * t977) * t944 - (t840 * t896 + t808 + t840) * t881 + qJ(3,2) * t955) * pkin(1);
t732 = -t923 - t953 + (t744 * t824 - (t762 + ((t856 + t928) * t839 + t807) * t978) * t946 - (t839 * t896 + t807 + t839) * t879 + qJ(3,3) * t956) * pkin(1);
t731 = (-t838 * t984 + t806 + t911) * t835 + (t914 * t841 + t794 + t803) * t832 + (-t761 * t826 - t760 * t942 + (t816 - 0.2e1 * t962) * t883 + t877 * t813) * pkin(1);
t730 = (-t837 * t985 + t805 + t912) * t834 + (t915 * t840 + t793 + t802) * t831 + (-t759 * t825 - t758 * t944 + (t815 - 0.2e1 * t960) * t881 + t875 * t812) * pkin(1);
t729 = (-t836 * t986 + t804 + t913) * t833 + (t916 * t839 + t792 + t801) * t830 + (-t757 * t824 - t756 * t946 + (t814 - 0.2e1 * t958) * t879 + t873 * t811) * pkin(1);
t728 = (t841 * t984 + t794 + t979) * t835 + (t914 * t838 + t806 - t911) * t832 + (-t761 * t942 + t760 * t826 + t813 * t973 + (-t961 - t964) * t841) * pkin(1);
t727 = (t840 * t985 + t793 + t980) * t834 + (t915 * t837 + t805 - t912) * t831 + (-t759 * t944 + t758 * t825 + t812 * t974 + (-t959 - t965) * t840) * pkin(1);
t726 = (t839 * t986 + t792 + t981) * t833 + (t916 * t836 + t804 - t913) * t830 + (-t757 * t946 + t756 * t824 + t811 * t975 + (-t957 - t966) * t839) * pkin(1);
t725 = -t866 * t921 - t951 + (t743 * t942 - t749 * t826 + t788 * t797) * pkin(1) + ((t905 - t967) * t835 + t904 * t832) * t897;
t724 = -t866 * t922 - t952 + (t742 * t944 - t748 * t825 + t784 * t796) * pkin(1) + ((t907 - t968) * t834 + t906 * t831) * t897;
t723 = -t866 * t923 - t953 + (t741 * t946 - t747 * t824 + t780 * t795) * pkin(1) + ((t909 - t969) * t833 + t908 * t830) * t897;
t722 = (t866 * t939 - t936) * qJ(3,1) + (t743 * t826 + t749 * t942 - t791 * t797) * pkin(1) + ((-t904 + t816) * t835 + t905 * t832) * t897;
t721 = (t866 * t940 - t937) * qJ(3,2) + (t742 * t825 + t748 * t944 - t787 * t796) * pkin(1) + ((-t906 + t815) * t834 + t907 * t831) * t897;
t720 = (t866 * t941 - t938) * qJ(3,3) + (t741 * t824 + t747 * t946 - t783 * t795) * pkin(1) + ((-t908 + t814) * t833 + t909 * t830) * t897;
