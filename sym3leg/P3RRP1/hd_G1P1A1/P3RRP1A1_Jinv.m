...
% Datum: 2019-05-03 15:34
% Revision: abbb0d669c4fc7889a31e0cf750ab51a4f2eb1ce (2019-05-03)
% Moritz Schappler, moritz.schappler@imes.uni-hannover.de
% (C) Institut für Mechatronische Systeme, Universität Hannover

function Jinv = P3RRP1G1P1A1_Jinv(xP, qJ, pkin, koppelP, ...
legFrame)
...
assert(isreal(qJ) && all(size(qJ) == [3 3]), ...
  'P3RRP1G1P1A1_Jinv: qJ has to be [3x3] (double)');
assert(isreal(xP) && all(size(xP) == [3 1]), ...
  'P3RRP1G1P1A1_Jinv: xP has to be [3x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [4 1]), ...
  'P3RRP1G1P1A1_Jinv: pkin has to be [4x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [3 3]), ...
  'P3RRP1G1P1A1_Jinv: legFrame has to be [3x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [3 3]), ...
  'P3RRP1G1P1A1_Jinv: Koppelpunkt has to be [3x3] (double)');

%% Symbolic Calculation
% From Jinv_para_matlab.m
% OptimizationMode: 2
% StartTime: 2019-05-03 15:34:07
% EndTime: 2019-05-03 15:34:09
...
t15 = [((t69 * t63 - t72 * t66) * qJ(3,1) + (-t21 * t57 - t9 * t165 + (t69 * t107 - t131 + t69) * t96 + (t118 * t57 - qJ(3,1) * (t69 * pkin(2) - t154)) * t93) * pkin(1)) * t3, ((-t72 * t63 - t69 * t66) * qJ(3,1) + (t9 * t57 - (t21 - 0.2e1 * (t54 * t72 + t51) * t93) * t165 - (t107 * t72 + t51 + t72) * t96 + (pkin(2) * t72 + t142) * t153) * pkin(1)) * t3, ((-(t33 * t72 - t69 * t36) * t66 + (t69 * t33 + t36 * t72) * t63) * qJ(3,1) + ((t177 * t96 + t93 * t6) * t57 - (-t93 * t177 + t6 * t96) * t165 - ((-t41 * t74 + t73 * t42) * t72 - t69 * (t73 * t41 + t42 * t74)) * t96 - ((t47 * t74 - t73 * t48) * t72 + (t73 * t47 + t48 * t74) * t69) * t153) * pkin(1)) / ((0.4e1 * (-t54 * t80 + t117 - t100 / 0.4e1 + t133) * t57 - t111) * t108 - t168); ((t68 * t62 - t71 * t65) * qJ(3,2) + (-t20 * t56 - t8 * t166 + (t68 * t107 - t130 + t68) * t95 + (t119 * t56 - qJ(3,2) * (t68 * pkin(2) - t151)) * t92) * pkin(1)) * t2, ((-t71 * t62 - t68 * t65) * qJ(3,2) + (t8 * t56 - (t20 - 0.2e1 * (t53 * t71 + t50) * t92) * t166 - (t107 * t71 + t50 + t71) * t95 + (pkin(2) * t71 + t143) * t150) * pkin(1)) * t2, ((-(t32 * t71 - t68 * t35) * t65 + (t68 * t32 + t35 * t71) * t62) * qJ(3,2) + ((-t173 * t95 + t92 * t5) * t56 - (t92 * t173 + t5 * t95) * t166 - ((-t39 * t74 + t73 * t40) * t71 - t68 * (t73 * t39 + t40 * t74)) * t95 - ((t45 * t74 - t73 * t46) * t71 + (t73 * t45 + t46 * t74) * t68) * t150) * pkin(1)) / ((0.4e1 * (-t53 * t79 + t116 - t99 / 0.4e1 + t133) * t56 - t110) * t108 - t169); ((t67 * t61 - t70 * t64) * qJ(3,3) + (-t19 * t55 - t7 * t167 + (t67 * t107 - t129 + t67) * t94 + (t120 * t55 - qJ(3,3) * (t67 * pkin(2) - t148)) * t91) * pkin(1)) * t1, ((-t70 * t61 - t67 * t64) * qJ(3,3) + (t7 * t55 - (t19 - 0.2e1 * (t52 * t70 + t49) * t91) * t167 - (t107 * t70 + t49 + t70) * t94 + (pkin(2) * t70 + t144) * t147) * pkin(1)) * t1, ((-(t31 * t70 - t67 * t34) * t64 + (t67 * t31 + t34 * t70) * t61) * qJ(3,3) + ((-t174 * t94 + t91 * t4) * t55 - (t91 * t174 + t4 * t94) * t167 - ((-t37 * t74 + t73 * t38) * t70 - t67 * (t73 * t37 + t38 * t74)) * t94 - ((t43 * t74 - t73 * t44) * t70 + (t73 * t43 + t44 * t74) * t67) * t147) * pkin(1)) / ((0.4e1 * (-t52 * t78 + t115 - t98 / 0.4e1 + t133) * t55 - t109) * t108 - t170);];
Jinv  = t15;
