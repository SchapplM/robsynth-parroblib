...
% Datum: 2020-09-28 23:17
% Revision: 8f4ff0ee124033641e65b154ac60823cef59ef1f (2020-07-05)
% Moritz Schappler, moritz.schappler@imes.uni-hannover.de
% (C) Institut für Mechatronische Systeme, Universität Hannover

function Jinv = P6RRPRRR14V3G5P4A1_Jinv(xP, qJ, pkin, koppelP, ...
legFrame)
...
assert(isreal(qJ) && all(size(qJ) == [3 6]), ...
  'P6RRPRRR14V3G5P4A1_Jinv: qJ has to be [3x6] (double)');
assert(isreal(xP) && all(size(xP) == [6 1]), ...
  'P6RRPRRR14V3G5P4A1_Jinv: xP has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [1 1]), ...
  'P6RRPRRR14V3G5P4A1_Jinv: pkin has to be [1x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [6 3]), ...
  'P6RRPRRR14V3G5P4A1_Jinv: legFrame has to be [6x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [6 3]), ...
  'P6RRPRRR14V3G5P4A1_Jinv: Koppelpunkt has to be [6x3] (double)');

%% Symbolic Calculation
% From Jinv_para_matlab.m
% OptimizationMode: 2
% StartTime: 2020-09-28 23:17:25
% EndTime: 2020-09-28 23:17:25
...
t2 = t69 * t44 + t8 * t72;
t1 = t69 * t43 + t7 * t72;
t19 = [-t149, t142, -t101, -t6 * t142 - t101 * (-t69 * t12 + t72 * t48), t101 * t18 - t6 * t149, t95 * ((t124 * t102 + t96 * t18) * t66 + (t18 * t102 - t124 * t96) * t60); -t150, t143, -t99, -t5 * t143 - t99 * (-t69 * t11 + t72 * t47), -t5 * t150 + t99 * t17, t93 * ((t125 * t100 + t94 * t17) * t65 + (t17 * t100 - t125 * t94) * t59); -t151, t144, -t97, -t4 * t144 - t97 * (-t69 * t10 + t72 * t46), -t4 * t151 + t97 * t16, t91 * ((t126 * t98 + t92 * t16) * t64 + (-t126 * t92 + t16 * t98) * t58); -t152, t145, -t89, -t3 * t145 - t89 * (t72 * t45 - t69 * t9), t89 * t15 - t3 * t152, t83 * ((t127 * t90 + t84 * t15) * t63 + (-t127 * t84 + t15 * t90) * t57); -t153, t146, -t87, -t2 * t146 - t87 * (t72 * t44 - t69 * t8), t87 * t14 - t2 * t153, t81 * ((t128 * t88 + t82 * t14) * t62 + (-t128 * t82 + t14 * t88) * t56); -t154, t147, -t85, -t1 * t147 - t85 * (t72 * t43 - t69 * t7), -t1 * t154 + t85 * t13, t79 * ((t129 * t86 + t80 * t13) * t61 + (-t129 * t80 + t13 * t86) * t55);];
Jinv  = t19;
