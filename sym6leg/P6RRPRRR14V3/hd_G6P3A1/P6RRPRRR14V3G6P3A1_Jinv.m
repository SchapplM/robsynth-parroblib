...
function Jinv = P6RRPRRR14V3G6P3A1_Jinv(xP, qJ, pkin, koppelP, ...
legFrame)
...
assert(isreal(qJ) && all(size(qJ) == [3 6]), ...
  'P6RRPRRR14V3G6P3A1_Jinv: qJ has to be [3x6] (double)');
assert(isreal(xP) && all(size(xP) == [6 1]), ...
  'P6RRPRRR14V3G6P3A1_Jinv: xP has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [1 1]), ...
  'P6RRPRRR14V3G6P3A1_Jinv: pkin has to be [1x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [6 3]), ...
  'P6RRPRRR14V3G6P3A1_Jinv: legFrame has to be [6x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [6 3]), ...
  'P6RRPRRR14V3G6P3A1_Jinv: Koppelpunkt has to be [6x3] (double)');

%% Symbolic Calculation
% From Jinv_para_matlab.m
% OptimizationMode: 2
% StartTime: 2020-09-28 23:19:01
% EndTime: 2020-09-28 23:19:01
...
t31 = [t30, -t27, t97, -t27 * t9 + t8 * t97, -t18 * t97 - t30 * t9, -t27 * t18 - t30 * t8; t29, -t26, t98, -t26 * t7 + t5 * t98, -t17 * t98 - t29 * t7, -t26 * t17 - t29 * t5; t28, -t25, t99, -t25 * t6 + t4 * t99, -t16 * t99 - t28 * t6, -t25 * t16 - t28 * t4; t24, -t21, t103, t3 * t103 - t12 * t21, -t15 * t103 - t12 * t24, -t21 * t15 - t24 * t3; t23, -t20, t104, t2 * t104 - t11 * t20, -t14 * t104 - t11 * t23, -t20 * t14 - t23 * t2; t22, -t19, t105, t1 * t105 - t10 * t19, -t10 * t22 - t13 * t105, -t22 * t1 - t19 * t13;];
Jinv  = t31;
