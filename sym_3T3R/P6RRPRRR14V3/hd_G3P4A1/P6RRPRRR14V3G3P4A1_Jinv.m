...
function Jinv = P6RRPRRR14V3G3P4A1_Jinv(xP, qJ, pkin, koppelP, ...
legFrame)
...
assert(isreal(qJ) && all(size(qJ) == [3 6]), ...
  'P6RRPRRR14V3G3P4A1_Jinv: qJ has to be [3x6] (double)');
assert(isreal(xP) && all(size(xP) == [6 1]), ...
  'P6RRPRRR14V3G3P4A1_Jinv: xP has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [1 1]), ...
  'P6RRPRRR14V3G3P4A1_Jinv: pkin has to be [1x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [6 3]), ...
  'P6RRPRRR14V3G3P4A1_Jinv: legFrame has to be [6x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [6 3]), ...
  'P6RRPRRR14V3G3P4A1_Jinv: Koppelpunkt has to be [6x3] (double)');

%% Symbolic Calculation
% From Jinv_para_matlab.m
% OptimizationMode: 2
% StartTime: 2020-09-28 23:13:50
% EndTime: 2020-09-28 23:13:50
...
t25 = [t24, -t21, -t106, -t8 * t106 - t21 * t9, t100 * t106 - t24 * t9, -t21 * t100 - t8 * t24; t23, -t20, -t108, -t5 * t108 - t20 * t7, t101 * t108 - t23 * t7, -t20 * t101 - t5 * t23; t22, -t19, -t110, -t4 * t110 - t19 * t6, t102 * t110 - t22 * t6, -t19 * t102 - t4 * t22; t18, -t15, -t112, -t3 * t112 - t12 * t15, t103 * t112 - t12 * t18, -t15 * t103 - t3 * t18; t17, -t14, -t114, -t11 * t14 - t2 * t114, t104 * t114 - t11 * t17, -t14 * t104 - t2 * t17; t16, -t13, -t116, -t1 * t116 - t10 * t13, -t10 * t16 + t105 * t116, -t1 * t16 - t13 * t105;];
Jinv  = t25;
