...
% Datum: 2020-09-28 23:19
% Revision: 8f4ff0ee124033641e65b154ac60823cef59ef1f (2020-07-05)
% Moritz Schappler, moritz.schappler@imes.uni-hannover.de
% (C) Institut für Mechatronische Systeme, Universität Hannover

function Jinv = P6RRPRRR14V3G6P4A1_Jinv(xP, qJ, pkin, koppelP, ...
legFrame)
...
assert(isreal(qJ) && all(size(qJ) == [3 6]), ...
  'P6RRPRRR14V3G6P4A1_Jinv: qJ has to be [3x6] (double)');
assert(isreal(xP) && all(size(xP) == [6 1]), ...
  'P6RRPRRR14V3G6P4A1_Jinv: xP has to be [6x1] (double)');
assert(isreal(pkin) && all(size(pkin) == [1 1]), ...
  'P6RRPRRR14V3G6P4A1_Jinv: pkin has to be [1x1] (double)');
assert(isreal(legFrame) && all(size(legFrame) == [6 3]), ...
  'P6RRPRRR14V3G6P4A1_Jinv: legFrame has to be [6x1] (double)');
assert(isreal(koppelP) && all(size(koppelP) == [6 3]), ...
  'P6RRPRRR14V3G6P4A1_Jinv: Koppelpunkt has to be [6x3] (double)');

%% Symbolic Calculation
% From Jinv_para_matlab.m
% OptimizationMode: 2
% StartTime: 2020-09-28 23:19:21
% EndTime: 2020-09-28 23:19:21
...
t31 = [t30, -t27, t103, t8 * t103 - t27 * t9, -t18 * t103 - t30 * t9, -t18 * t27 - t30 * t8; t29, -t26, t104, t5 * t104 - t26 * t7, -t17 * t104 - t29 * t7, -t17 * t26 - t29 * t5; t28, -t25, t105, t4 * t105 - t25 * t6, -t16 * t105 - t28 * t6, -t16 * t25 - t28 * t4; t24, -t21, t109, t3 * t109 - t12 * t21, -t15 * t109 - t12 * t24, -t15 * t21 - t24 * t3; t23, -t20, t110, -t11 * t20 + t2 * t110, -t11 * t23 - t14 * t110, -t14 * t20 - t2 * t23; t22, -t19, t111, t1 * t111 - t10 * t19, -t10 * t22 - t13 * t111, -t1 * t22 - t13 * t19;];
Jinv  = t31;
